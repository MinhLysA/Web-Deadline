        ...
        <div class="section-container">
            ...
            <div class="main-video-section">
                <?php if ($featured_video): ?>
                    <a href="Video_v2.php?id=<?php echo $featured_video['id']; ?>" class="video-link" aria-label="Xem video nổi bật">
                        <div class="video-placeholder" style="background-image: url('<?php echo $featured_video['anh_minh_hoa']; ?>');"></div>
                    </a>
                    <a href="Video_v2.php?id=<?php echo $featured_video['id']; ?>" class="play-button" aria-label="Phát video">▶</a>
        ...
        <div class="section-container">
            ...
            <div class="video-thumbnails">
                <?php foreach ($video_list as $video): ?>
                    <div class="thumbnail">
                        <a href="Video_v2.php?id=<?php echo $video['id']; ?>" class="video-link" aria-label="Xem video <?php echo htmlspecialchars($video['tieude']); ?>">
